...
def extract_and_partition_bikeshare_data(project_id, dataset_table, bucket_name):
...
def create_external_table_single_partition(project_id, dataset_id, table_id, bucket_name, delete_if_exists=True):
